  ...
  export default defineComponent({
    ...
    setup(_, { emit }) {
      ...
      const userSubsidiaryTableRef = ref<{
        ...
        setOrganizationColumnData: () => void;
        setPositionColumnOptions: () => void;
      } | null>(null);
      ...
      const [registerDrawer, { setDrawerProps, closeDrawer }] = useDrawerInner(async (data) => {
        ...
        await userSubsidiaryTableRef.value?.setOrganizationColumnData();
        await userSubsidiaryTableRef.value?.setPositionColumnOptions(null);
        if (unref(isUpdate)) {
          setFieldsValue({
            ...data.record,
          });
